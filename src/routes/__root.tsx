...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Academia HQ Blog — Education News, Exams & Scholarships" },
      { property: "og:description", content: "Trusted education news for students, teachers and parents in Nigeria and Africa." },
